...
function SheetContent({
  ...
  return (
    <SheetPrimitive.Portal container={containerId ? container : undefined}>
      <SheetOverlay />
      <SheetPrimitive.Content
        data-slot="sheet-content"
        data-side={side}
        className={cn(
          'absolute z-50 flex flex-col gap-4 bg-background bg-clip-padding text-sm shadow-lg transition duration-200 ease-in-out',
