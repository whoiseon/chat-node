...
export const serverJoinTypeSchema = z.enum(Object.values(SERVER_JOIN_TYPE));

export type ServerJoinType = z.infer<typeof serverJoinTypeSchema>;
...
export const serverCreateSchema = z.object({
  ...
  joinType: serverJoinTypeSchema.default(SERVER_JOIN_TYPE.DIRECT),
});

export type ServerCreateSchema = z.infer<typeof serverCreateSchema>;
